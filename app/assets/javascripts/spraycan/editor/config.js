var Spraycan = {
  ...
  animate_resize: function(height){
    ...
    if(Spraycan.editor.maximised==true){
      height = $(window).height() + 10;
    }else if(Spraycan.editor.minimised==true){
      height = 40 + 10;
    }else{
      height = height + 40; //pad for toolbar
    }
    ...
    $('iframe').animate({height: (($(window).height() + 10) - height) + 'px'}, t);
